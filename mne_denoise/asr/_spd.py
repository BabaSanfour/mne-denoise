"""Symmetric positive-definite (SPD) / Riemannian matrix primitives for ASR.

These low-level linear-algebra helpers (robust covariance aggregation, matrix
square root / log / exp on the SPD manifold, the affine-invariant Karcher mean,
and the rASR nonlinear eigenspace) are factored out of
:mod:`mne_denoise.asr.core` to keep that module focused on the calibration and
processing pipeline. Import them from this module
(``from mne_denoise.asr._spd import _sqrtm_spd``).
"""
